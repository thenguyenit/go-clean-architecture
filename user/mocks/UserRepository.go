...
func (_m *UserRepository) Fetch(ctx context.Context, page int, number int) ([]*models.User, error) {
...
func (_m *UserRepository) Insert(ctx context.Context, _a1 *models.User) error {
